...
https://github.com/RajaS/ACTextCtrl/blob/master
...
class SearchCtrlAutoComplete (wx.TextCtrl, listmix.ColumnSorterMixin ):
    ...
    def __init__ ( self, parent, colNames=None, choices = None,
                  ...
                  **therest) :
        '''
        Constructor works just like wx.SearchCtrl except you can pass in a
    ...
    def _setValueFromSelected( self ) :
         '''
         Sets the wx.SearchCtrl value from the selected wx.ListCtrl item.
...
class test:
    def __init__(self):
        ...
        self._ctrl = SearchCtrlAutoComplete(panel, **args)
